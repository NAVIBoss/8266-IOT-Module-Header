...
void X3MBuzer::en() {if(save.buzer) return; CMn("Buzer ВКЛ"); go(13); save.buzer=1; MQTTStatus("Buzer", "ON"); saveChange(1);}
void X3MBuzer::dis() {if(!save.buzer) return; CMn("Buzer ВЫКЛ"); go(14); save.buzer=0; MQTTStatus("Buzer", "OFF"); saveChange(1);}

void X3MBuzer::status() {CM("Назначен пин на Buzer: "); CMn(BuzerPIN); go(17);}

void X3MBuzer::go(uint8_t in=0) {static uint8_t nextSound;
if((!save.buzer && in!=16 && in!=13 && !mode) || (!in && !mode)) {return;} if(in && mode) {nextSound=in; CM("Save sound: "); CMn(in);}
...
case 1: BUZ(1); timeWait=1; break;
case 2: BUZ(0); mode=0; break;} break; 
// ::::::::::::::::::::::::::::::::::::::::::::::::::::::::
case 2: switch (mode) { // Двойной клик кнопки
case 1: BUZ(1); timeWait=1; break;
case 3: BUZ(1); timeWait=2; break;
case 2: BUZ(0); timeWait=70; break;
...
case 1: case 3: case 5: case 7: case 9:BUZ(1); timeWait=1; break;
case 2: case 4: case 6: case 8: case 10: BUZ(0); timeWait=20; break;
case 11: mode=0; break;
} break; 
// ::::::::::::::::::::::::::::::::::::::::::::::::::::::::
case 25: switch (mode) { // Клик + удержание кнопки
case 1: BUZ(1); timeWait=1; break;
case 3: BUZ(1); timeWait=2; break;
case 2: BUZ(0); timeWait=70; break;
case 5: case 7: case 9: case 11: BUZ(1); timeWait=1; break;
case 4: case 6: case 8: case 10: case 12: BUZ(0); timeWait=20; break;
